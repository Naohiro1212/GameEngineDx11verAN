...
Texture::Texture():pSampleLinear_(nullptr), pTextureSRV_(nullptr), size_(XMFLOAT3(0,0,0))
{
}
...
HRESULT Texture::Load(std::string fileName)
{
    ...
    {
        char message[256];
        sprintf_s(message, "「%s」が見つかりません", fileName.c_str());
        MessageBoxA(0, message, "画像ファイルの読み込みに失敗", MB_OK);
        return hr;
    }
